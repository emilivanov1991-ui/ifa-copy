                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2 sm:col-span-2">
                        ...
                        <Input
                          type="number"
                          min="0"
                          value={data.property_2_insurance_monthly ?? ''}
                          onChange={(e) => onChange('property_2_insurance_monthly', e.target.value === '' ? '' : parseFloat(e.target.value))}
                          className="rounded-lg w-40"
                          placeholder="0"
                        />
                      </div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2 sm:col-span-2">
                        ...
                        <Input
                          type="number"
                          min="0"
                          value={data.property_3_insurance_monthly ?? ''}
                          onChange={(e) => onChange('property_3_insurance_monthly', e.target.value === '' ? '' : parseFloat(e.target.value))}
                          className="rounded-lg w-40"
                          placeholder="0"
                        />
                      </div>
              ...
              <div className="ml-6 p-4 bg-white rounded-lg border border-slate-200 space-y-4">
                ...
                <div className="pt-4 border-t border-slate-200 space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      type="number" min="0"
                      value={data.car_1_go_monthly ?? ''}
                      onChange={(e) => onChange('car_1_go_monthly', e.target.value === '' ? '' : parseFloat(e.target.value))}
                  ...
                  {data.car_1_has_casco && (
                    <div className="grid sm:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2 sm:col-span-2">
                        ...
                        <Input
                          type="number" min="0"
                          value={data.car_1_casco_monthly ?? ''}
                          onChange={(e) => onChange('car_1_casco_monthly', e.target.value === '' ? '' : parseFloat(e.target.value))}
                          className="rounded-lg w-40" placeholder="0"
                        />
                      </div>
                    </div>
                  ...
                  {data.car_2_has_casco && (
                    <div className="grid sm:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2 sm:col-span-2">
                        ...
                        <Input
                          type="number" min="0"
                          value={data.car_2_casco_monthly ?? ''}
                          onChange={(e) => onChange('car_2_casco_monthly', e.target.value === '' ? '' : parseFloat(e.target.value))}
                          className="rounded-lg w-40" placeholder="0"
                        />
                      </div>
                    </div>
              ...
              <div className="ml-6 p-4 bg-white rounded-lg border border-slate-200 space-y-4">
                ...
                <div className="pt-4 border-t border-slate-200 space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      type="number" min="0"
                      value={data.car_3_go_monthly ?? ''}
                      onChange={(e) => onChange('car_3_go_monthly', e.target.value === '' ? '' : parseFloat(e.target.value))}
                      className="rounded-lg w-40" placeholder="0"
                    />
                  </div>
                </div>
                  ...
                  {data.car_3_has_casco && (
                    <div className="grid sm:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2 sm:col-span-2">
                        ...
                        <Input
                          type="number" min="0"
                          value={data.car_3_casco_monthly ?? ''}
                          onChange={(e) => onChange('car_3_casco_monthly', e.target.value === '' ? '' : parseFloat(e.target.value))}
                          className="rounded-lg w-40" placeholder="0"
                        />
                      </div>
                    </div>
