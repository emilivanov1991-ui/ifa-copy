...
export default function GeneraliHealthLineBasic() {
  const monthlyPremium = 60;
  const annualPremium = 720;
    ...
    <Card className="bg-white shadow-lg">
      <CardHeader className="bg-gradient-to-r from-red-600 to-red-700 text-white">
        <div className="flex items-center gap-3">
          ...
          />
          <div>
            <CardTitle className="text-xl">HEALTH Line - Basic</CardTitle>
            <p className="text-xs text-red-100 mt-1">Допълнително здравно осигуряване</p>
          </div>
        </div>
      </CardHeader>
          ...
          <div className="bg-white border border-slate-200 rounded-lg p-4">
            ...
            <div className="space-y-2 text-sm text-slate-600 ml-6">
              <div className="flex justify-between">
                ...
                <span className="font-medium">40 BGN/ден</span>
              </div>
              <div className="flex justify-between">
                <span>• Интензивно отделение:</span>
                <span className="font-medium">80 BGN/ден</span>
              </div>
              <div className="flex justify-between">
                <span>• Оперативна намеса:</span>
                <span className="font-medium">До 3,000 BGN</span>
              </div>
              <div className="flex justify-between">
                <span>• Медикаменти в болница:</span>
                <span className="font-medium">До 500 BGN</span>
              </div>
              <div className="flex justify-between">
                <span>• Транспорт/линейка:</span>
                <span className="font-medium">До 200 BGN</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-lg p-4">
            ...
            <div className="space-y-2 text-sm text-slate-600 ml-6">
              <div className="flex justify-between">
                ...
                <span className="font-medium">До 500 BGN/год</span>
              </div>
              <div className="flex justify-between">
                <span>• Изследвания:</span>
                <span className="font-medium">До 300 BGN/год</span>
              </div>
              <div className="flex justify-between">
                <span>• Медикаменти:</span>
                <span className="font-medium">До 200 BGN/год</span>
              </div>
              <div className="flex justify-between">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="text-xs text-blue-800 space-y-2">
            ...
            <ul className="space-y-1 ml-4">
              ...
              <li>• Самоучастие: 20% при извънболнично лечение</li>
