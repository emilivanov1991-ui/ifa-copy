    ...
    <div className="space-y-8 relative">
      ...
      <div className="bg-slate-50 rounded-xl p-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          <div className="space-y-2" data-invalid={isFieldInvalid(data.client_first_name) ? 'true' : undefined}>
            ...
            <Input value={data.client_first_name || ''} onChange={(e) => onChange('client_first_name', e.target.value)} className={`rounded-lg ${isFieldInvalid(data.client_first_name) ? 'border-red-500 bg-red-50' : ''}`} required />
          </div>
          <div className="space-y-2" data-invalid={isFieldInvalid(data.client_middle_name) ? 'true' : undefined}>
            ...
            <Input value={data.client_middle_name || ''} onChange={(e) => onChange('client_middle_name', e.target.value)} className={`rounded-lg ${isFieldInvalid(data.client_middle_name) ? 'border-red-500 bg-red-50' : ''}`} required />
          </div>
          <div className="space-y-2" data-invalid={isFieldInvalid(data.client_last_name) ? 'true' : undefined}>
            ...
            <Input value={data.client_last_name || ''} onChange={(e) => onChange('client_last_name', e.target.value)} className={`rounded-lg ${isFieldInvalid(data.client_last_name) ? 'border-red-500 bg-red-50' : ''}`} required />
          </div>
          ...
          <div className="space-y-2" data-invalid={isFieldInvalid(data.client_birthdate) ? 'true' : undefined}>
            ...
            <BulgarianDateInput value={data.client_birthdate || ''} onChange={(value) => onChange('client_birthdate', value)} className={`rounded-lg ${isFieldInvalid(data.client_birthdate) ? 'border-red-500 bg-red-50' : ''}`} required />
          </div>
          ...
          <div className="space-y-2" data-invalid={isFieldInvalid(data.client_gender) ? 'true' : undefined}>
            ...
            <Select value={data.client_gender || ''} onValueChange={(value) => onChange('client_gender', value)}>
              <SelectTrigger className={`rounded-lg ${isFieldInvalid(data.client_gender) ? 'border-red-500 bg-red-50' : ''}`}><SelectValue placeholder="Изберете" /></SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-2" data-invalid={isFieldInvalid(data.client_birthplace) ? 'true' : undefined}>
            ...
            <Input value={data.client_birthplace || ''} onChange={(e) => onChange('client_birthplace', e.target.value)} className={`rounded-lg ${isFieldInvalid(data.client_birthplace) ? 'border-red-500 bg-red-50' : ''}`} required />
          </div>
          <div className="space-y-2" data-invalid={isFieldInvalid(data.client_egn) ? 'true' : undefined}>
            <Label>ЕГН <span className="text-red-500">*</span></Label>
            <Input placeholder="0000000000" value={data.client_egn || ''} onChange={(e) => onChange('client_egn', e.target.value)} className={`rounded-lg ${isFieldInvalid(data.client_egn) ? 'border-red-500 bg-red-50' : data.client_egn?.length === 10 && !validateEGN(data.client_egn).valid ? 'border-red-500' : data.client_egn?.length === 10 && validateEGN(data.client_egn).valid ? 'border-green-500' : ''}`} required />
          ...
          <div className="space-y-2" data-invalid={isFieldInvalid(data.client_id_valid_until) ? 'true' : undefined}>
            <Label>Лична карта валидна до <span className="text-red-500">*</span></Label>
            <BulgarianDateInput value={data.client_id_valid_until || ''} onChange={(value) => onChange('client_id_valid_until', value)} className={`rounded-lg ${isFieldInvalid(data.client_id_valid_until) ? 'border-red-500 bg-red-50' : ''}`} required />
          </div>
          <div className="space-y-2 sm:col-span-2" data-invalid={isFieldInvalid(data.client_address) ? 'true' : undefined}>
            <Label>Постоянен адрес <span className="text-red-500">*</span></Label>
            <Input value={data.client_address || ''} onChange={(e) => onChange('client_address', e.target.value)} className={`rounded-lg ${isFieldInvalid(data.client_address) ? 'border-red-500 bg-red-50' : ''}`} required />
          </div>
          ...
          <div className="space-y-2" data-invalid={isFieldInvalid(data.client_marital_status) ? 'true' : undefined}>
            ...
            <Select value={data.client_marital_status || ''} onValueChange={(value) => onChange('client_marital_status', value)}>
              <SelectTrigger className={`rounded-lg ${isFieldInvalid(data.client_marital_status) ? 'border-red-500 bg-red-50' : ''}`}><SelectValue placeholder="Изберете" /></SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-2" data-invalid={isFieldInvalid(data.client_nationality) ? 'true' : undefined}>
            ...
            <Select value={data.client_nationality || ''} onValueChange={(value) => onChange('client_nationality', value)}>
              <SelectTrigger className={`rounded-lg ${isFieldInvalid(data.client_nationality) ? 'border-red-500 bg-red-50' : ''}`}><SelectValue placeholder="Изберете" /></SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-2" data-invalid={isFieldInvalid(data.client_bank) ? "true" : undefined}>
            ...
            <Select value={data.client_bank || ''} onValueChange={(value) => onChange('client_bank', value)}>
              <SelectTrigger className={`rounded-lg ${isFieldInvalid(data.client_bank) ? 'border-red-500 bg-red-50' : ''}`}><SelectValue placeholder="Изберете" /></SelectTrigger>
              <SelectContent>
        ...
        <div className="border-t border-slate-200 pt-4">
          ...
          {data.client_is_employed ? (
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="space-y-2 sm:col-span-2 lg:col-span-3" data-invalid={isFieldInvalid(data.client_job_description) ? "true" : undefined}>
                <Label>Описание на месторабота и трудови задължения <span className="text-red-500">*</span></Label>
                <Input placeholder="Описание на длъжността..." value={data.client_job_description || ''} onChange={(e) => onChange('client_job_description', e.target.value)} className={`rounded-lg ${isFieldInvalid(data.client_job_description) ? 'border-red-500 bg-red-50' : ''}`} required />
              </div>
              <div className="space-y-2" data-invalid={isFieldInvalid(data.client_employer_name) ? "true" : undefined}>
                <Label>Име на работодател <span className="text-red-500">*</span></Label>
                <Input value={data.client_employer_name || ''} onChange={(e) => onChange('client_employer_name', e.target.value)} className={`rounded-lg ${isFieldInvalid(data.client_employer_name) ? 'border-red-500 bg-red-50' : ''}`} required />
              </div>
              <div className="space-y-2">
                <Label>Град</Label>
              ...
              <div className="space-y-2" data-invalid={isFieldInvalid(data.client_contract_type) ? "true" : undefined}>
                ...
                <Select value={data.client_contract_type || ''} onValueChange={(value) => onChange('client_contract_type', value)}>
                  <SelectTrigger className={`rounded-lg ${isFieldInvalid(data.client_contract_type) ? 'border-red-500 bg-red-50' : ''}`}><SelectValue placeholder="Изберете" /></SelectTrigger>
                  <SelectContent>
              ...
              <div className="space-y-2" data-invalid={isFieldInvalid(data.client_contract_term) ? "true" : undefined}>
                ...
                <Select value={data.client_contract_term || ''} onValueChange={(value) => onChange('client_contract_term', value)}>
                  <SelectTrigger className={`rounded-lg ${isFieldInvalid(data.client_contract_term) ? 'border-red-500 bg-red-50' : ''}`}><SelectValue placeholder="Изберете" /></SelectTrigger>
                  <SelectContent>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="space-y-2" data-invalid={isFieldInvalid(data.client_income_source) ? "true" : undefined}>
                <Label>Източник на доход <span className="text-red-500">*</span></Label>
                <Input placeholder="Например: Наеми, Дивиденти..." value={data.client_income_source || ''} onChange={(e) => onChange('client_income_source', e.target.value)} className={`rounded-lg ${isFieldInvalid(data.client_income_source) ? 'border-red-500 bg-red-50' : ''}`} required />
              </div>
              <div className="space-y-2" data-invalid={isFieldInvalid(data.client_activity) ? "true" : undefined}>
                <Label>Дейност <span className="text-red-500">*</span></Label>
                <Input placeholder="Описание на дейността..." value={data.client_activity || ''} onChange={(e) => onChange('client_activity', e.target.value)} className={`rounded-lg ${isFieldInvalid(data.client_activity) ? 'border-red-500 bg-red-50' : ''}`} required />
              </div>
            </div>
          )}
        </div>
        ...
        <HealthQuestionnaire data={data} onChange={onChange} prefix="client" showErrors={showErrors} />
      </div>
      ...
      <div className="bg-slate-50 rounded-xl p-6">
        ...
        {data.include_partner && (
          <>
            {/* Personal Info */}
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
              <div className="space-y-2" data-invalid={isFieldInvalid(data.partner_first_name) ? "true" : undefined}>
                <Label>Име <span className="text-red-500">*</span></Label>
                <Input value={data.partner_first_name || ''} onChange={(e) => onChange('partner_first_name', e.target.value)} className={`rounded-lg ${isFieldInvalid(data.partner_first_name) ? 'border-red-500 bg-red-50' : ''}`} required />
              </div>
              <div className="space-y-2" data-invalid={isFieldInvalid(data.partner_middle_name) ? "true" : undefined}>
                <Label>Презиме <span className="text-red-500">*</span></Label>
                <Input value={data.partner_middle_name || ''} onChange={(e) => onChange('partner_middle_name', e.target.value)} className={`rounded-lg ${isFieldInvalid(data.partner_middle_name) ? 'border-red-500 bg-red-50' : ''}`} required />
              </div>
              <div className="space-y-2" data-invalid={isFieldInvalid(data.partner_last_name) ? "true" : undefined}>
                <Label>Фамилия <span className="text-red-500">*</span></Label>
                <Input value={data.partner_last_name || ''} onChange={(e) => onChange('partner_last_name', e.target.value)} className={`rounded-lg ${isFieldInvalid(data.partner_last_name) ? 'border-red-500 bg-red-50' : ''}`} required />
              </div>

              <div className="space-y-2" data-invalid={isFieldInvalid(data.partner_birthdate) ? "true" : undefined}>
                <Label>Дата на раждане <span className="text-red-500">*</span></Label>
                <BulgarianDateInput value={data.partner_birthdate || ''} onChange={(value) => onChange('partner_birthdate', value)} className={`rounded-lg ${isFieldInvalid(data.partner_birthdate) ? 'border-red-500 bg-red-50' : ''}`} required />
              </div>
              <div className="space-y-2">
                <Label>Възраст</Label>
                <Input type="number" value={data.partner_age || ''} readOnly className="rounded-lg bg-slate-100" />
              </div>
              <div className="space-y-2" data-invalid={isFieldInvalid(data.partner_gender) ? "true" : undefined}>
                <Label>Пол <span className="text-red-500">*</span></Label>
                <Select value={data.partner_gender || ''} onValueChange={(value) => onChange('partner_gender', value)}>
                  <SelectTrigger className={`rounded-lg ${isFieldInvalid(data.partner_gender) ? 'border-red-500 bg-red-50' : ''}`}><SelectValue placeholder="Изберете" /></SelectTrigger>
                  <SelectContent>
                    <SelectItem value="male">Мъж</SelectItem>
                    <SelectItem value="female">Жена</SelectItem>
                  </SelectContent>
              ...
              <div className="space-y-2" data-invalid={isFieldInvalid(data.partner_birthplace) ? "true" : undefined}>
                <Label>Място на раждане <span className="text-red-500">*</span></Label>
                <Input value={data.partner_birthplace || ''} onChange={(e) => onChange('partner_birthplace', e.target.value)} className={`rounded-lg ${isFieldInvalid(data.partner_birthplace) ? 'border-red-500 bg-red-50' : ''}`} required />
              </div>
              <div className="space-y-2" data-invalid={isFieldInvalid(data.partner_egn) ? "true" : undefined}>
                <Label>ЕГН <span className="text-red-500">*</span></Label>
                <Input placeholder="0000000000" value={data.partner_egn || ''} onChange={(e) => onChange('partner_egn', e.target.value)} className={`rounded-lg ${isFieldInvalid(data.partner_egn) ? 'border-red-500 bg-red-50' : data.partner_egn?.length === 10 && !validateEGN(data.partner_egn).valid ? 'border-red-500' : data.partner_egn?.length === 10 && validateEGN(data.partner_egn).valid ? 'border-green-500' : ''}`} required />
              ...
              <div className="space-y-2" data-invalid={isFieldInvalid(data.partner_id_valid_until) ? "true" : undefined}>
                <Label>Лична карта валидна до <span className="text-red-500">*</span></Label>
                <BulgarianDateInput value={data.partner_id_valid_until || ''} onChange={(value) => onChange('partner_id_valid_until', value)} className={`rounded-lg ${isFieldInvalid(data.partner_id_valid_until) ? 'border-red-500 bg-red-50' : ''}`} required />
              </div>
              <div className="space-y-2 sm:col-span-2" data-invalid={isFieldInvalid(data.partner_address) ? "true" : undefined}>
                <Label>Постоянен адрес <span className="text-red-500">*</span></Label>
                <Input value={data.partner_address || ''} onChange={(e) => onChange('partner_address', e.target.value)} className={`rounded-lg ${isFieldInvalid(data.partner_address) ? 'border-red-500 bg-red-50' : ''}`} required />
              </div>
              ...
              <div className="space-y-2" data-invalid={isFieldInvalid(data.partner_marital_status) ? "true" : undefined}>
                ...
                <Select value={data.partner_marital_status || ''} onValueChange={(value) => onChange('partner_marital_status', value)}>
                  <SelectTrigger className={`rounded-lg ${isFieldInvalid(data.partner_marital_status) ? 'border-red-500 bg-red-50' : ''}`}><SelectValue placeholder="Изберете" /></SelectTrigger>
                  <SelectContent>
                    <SelectItem value="single">Неженен/Неомъжена</SelectItem>
                    <SelectItem value="married">Женен/Омъжена</SelectItem>
                    <SelectItem value="divorced">Разведен/а</SelectItem>
              ...
              <div className="space-y-2" data-invalid={isFieldInvalid(data.partner_nationality) ? "true" : undefined}>
                <Label>Националност <span className="text-red-500">*</span></Label>
                <Select value={data.partner_nationality || ''} onValueChange={(value) => onChange('partner_nationality', value)}>
                  <SelectTrigger className={`rounded-lg ${isFieldInvalid(data.partner_nationality) ? 'border-red-500 bg-red-50' : ''}`}><SelectValue placeholder="Изберете" /></SelectTrigger>
                  <SelectContent>
                    <SelectItem value="bulgarian">Българска</SelectItem>
                    <SelectItem value="other_eu">Друга от ЕС</SelectItem>
                    <SelectItem value="non_eu">Извън ЕС</SelectItem>
              ...
              <div className="space-y-2" data-invalid={isFieldInvalid(data.partner_bank) ? "true" : undefined}>
                <Label>Банка <span className="text-red-500">*</span></Label>
                <Select value={data.partner_bank || ''} onValueChange={(value) => onChange('partner_bank', value)}>
                  <SelectTrigger className={`rounded-lg ${isFieldInvalid(data.partner_bank) ? 'border-red-500 bg-red-50' : ''}`}><SelectValue placeholder="Изберете" /></SelectTrigger>
                  <SelectContent>
                    {BANK_OPTIONS.map(bank => (<SelectItem key={bank.value} value={bank.value}>{bank.label}</SelectItem>))}
                  </SelectContent>
                </Select>
            ...
            <div className="border-t border-slate-200 pt-4">
              ...
              {(data.partner_is_employed ?? true) ? (
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  <div className="space-y-2 sm:col-span-2 lg:col-span-3" data-invalid={isFieldInvalid(data.partner_job_description) ? "true" : undefined}>
                    <Label>Описание на месторабота и трудови задължения <span className="text-red-500">*</span></Label>
                    <Input placeholder="Описание на длъжността..." value={data.partner_job_description || ''} onChange={(e) => onChange('partner_job_description', e.target.value)} className={`rounded-lg ${isFieldInvalid(data.partner_job_description) ? 'border-red-500 bg-red-50' : ''}`} required />
                  </div>
                  <div className="space-y-2" data-invalid={isFieldInvalid(data.partner_employer_name) ? "true" : undefined}>
                    <Label>Име на работодател <span className="text-red-500">*</span></Label>
                    <Input value={data.partner_employer_name || ''} onChange={(e) => onChange('partner_employer_name', e.target.value)} className={`rounded-lg ${isFieldInvalid(data.partner_employer_name) ? 'border-red-500 bg-red-50' : ''}`} required />
                  </div>
                  <div className="space-y-2">
                    <Label>Град</Label>
                  ...
                  <div className="space-y-2" data-invalid={isFieldInvalid(data.partner_contract_type) ? "true" : undefined}>
                    ...
                    <Select value={data.partner_contract_type || ''} onValueChange={(value) => onChange('partner_contract_type', value)}>
                      <SelectTrigger className={`rounded-lg ${isFieldInvalid(data.partner_contract_type) ? 'border-red-500 bg-red-50' : ''}`}><SelectValue placeholder="Изберете" /></SelectTrigger>
                      <SelectContent>
                        <SelectItem value="labor">Трудов договор</SelectItem>
                        <SelectItem value="civil">Граждански договор</SelectItem>
                      </SelectContent>
                  ...
                  <div className="space-y-2" data-invalid={isFieldInvalid(data.partner_contract_term) ? "true" : undefined}>
                    <Label>Срок на договора <span className="text-red-500">*</span></Label>
                    <Select value={data.partner_contract_term || ''} onValueChange={(value) => onChange('partner_contract_term', value)}>
                      <SelectTrigger className={`rounded-lg ${isFieldInvalid(data.partner_contract_term) ? 'border-red-500 bg-red-50' : ''}`}><SelectValue placeholder="Изберете" /></SelectTrigger>
                      <SelectContent>
                        <SelectItem value="fixed">Срочен договор</SelectItem>
                        <SelectItem value="permanent">Постоянен договор</SelectItem>
                      </SelectContent>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-2" data-invalid={isFieldInvalid(data.partner_income_source) ? "true" : undefined}>
                    <Label>Източник на доход <span className="text-red-500">*</span></Label>
                    <Input placeholder="Например: Наеми, Дивиденти..." value={data.partner_income_source || ''} onChange={(e) => onChange('partner_income_source', e.target.value)} className={`rounded-lg ${isFieldInvalid(data.partner_income_source) ? 'border-red-500 bg-red-50' : ''}`} required />
                  </div>
                  <div className="space-y-2" data-invalid={isFieldInvalid(data.partner_activity) ? "true" : undefined}>
                    <Label>Дейност <span className="text-red-500">*</span></Label>
                    <Input placeholder="Описание на дейността..." value={data.partner_activity || ''} onChange={(e) => onChange('partner_activity', e.target.value)} className={`rounded-lg ${isFieldInvalid(data.partner_activity) ? 'border-red-500 bg-red-50' : ''}`} required />
                  </div>
                </div>
              )}
            </div>

            <HealthQuestionnaire data={data} onChange={onChange} prefix="partner" showErrors={showErrors} />
          </>
        )}
      ...
      <div className="bg-slate-50 rounded-xl p-6">
        ...
        <div className="space-y-4">
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="space-y-2" data-invalid={isFieldInvalid(data.children_count) ? "true" : undefined}>
              ...
              <Select value={data.children_count?.toString() || ''} onValueChange={(value) => onChange('children_count', parseInt(value))}>
                <SelectTrigger className={`rounded-lg ${isFieldInvalid(data.children_count) ? 'border-red-500 bg-red-50' : ''}`}><SelectValue placeholder="Изберете" /></SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-3 pt-4 border-t border-slate-200">
              ...
              {Array.from({ length: data.children_count || 0 }).map((_, index) => (
                <div key={index} className="grid sm:grid-cols-2 gap-3 p-3 bg-white rounded-lg border border-slate-200">
                  <div className="space-y-1" data-invalid={isFieldInvalid(data[`child_${index + 1}_name`]) ? "true" : undefined}>
                    <Label className="text-xs">Дете {index + 1} - Име <span className="text-red-500">*</span></Label>
                    <Input value={data[`child_${index + 1}_name`] || ''} onChange={(e) => onChange(`child_${index + 1}_name`, e.target.value)} className={`rounded-lg ${isFieldInvalid(data[`child_${index + 1}_name`]) ? 'border-red-500 bg-red-50' : ''}`} required />
                  </div>
                  <div className="space-y-1" data-invalid={isFieldInvalid(data[`child_${index + 1}_birthdate`]) ? "true" : undefined}>
                    <Label className="text-xs">Дата на раждане <span className="text-red-500">*</span></Label>
                    <BulgarianDateInput value={data[`child_${index + 1}_birthdate`] || ''} onChange={(value) => onChange(`child_${index + 1}_birthdate`, value)} className={`rounded-lg ${isFieldInvalid(data[`child_${index + 1}_birthdate`]) ? 'border-red-500 bg-red-50' : ''}`} required />
                  </div>
                </div>
              ))}
            </div>
