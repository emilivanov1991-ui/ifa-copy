...
export const PLAN_CONSTITUTION = {
  ...
  optimization: {
    ...
    mortgage: {
      ...
      // ⚠️ ТЕХНИЧЕСКА ЗАДАЧА: Визуализацията в презентацията на финансовия план предстои да се дизайне —
      //    трябва да се реши как slide-ът за Оптимизация изглежда при "не е изгодно" сценарий
