          ...
          <CardContent className="pt-5 pb-5">
            <div className="flex flex-col md:flex-row md:items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <Label className="text-sm font-semibold text-purple-900">Пакет "Избор" - Застрахователна сума:</Label>
              </div>
              <div className="flex items-center gap-3">
                <Input 
                  ...
                  max={500000}
                  step={1000}
                  className="w-48 font-semibold text-purple-700 border-purple-300 focus:ring-purple-500 focus:border-purple-500 transition-all"
                />
                <span className="text-sm font-medium text-purple-700">лв (BGN)</span>
              </div>
            </div>
